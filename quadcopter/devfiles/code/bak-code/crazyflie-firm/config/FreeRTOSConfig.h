...
//#define configTOTAL_HEAP_SIZE		( ( size_t ) ( 15000 ) )//comment by titron
#define configTOTAL_HEAP_SIZE		( ( size_t ) ( 14000 ) )//added by titron
#define configMAX_TASK_NAME_LEN		( 10 )
#define configUSE_TRACE_FACILITY	0
#define configUSE_16_BIT_TICKS		0
#if 0
#define configIDLE_SHOULD_YIELD		0//comment by titron
#else
