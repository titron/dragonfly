...
void pmInit(void)
{
  ...
  xTaskCreate(pmTask, (char const * const)"PWRMGNT",
...
//  vTaskSetApplicationTaskTag(0, (void*)TASK_PM_ID_NBR);//comment by titron
  vTaskSetApplicationTaskTag(0, (pdTASK_HOOK_CODE)TASK_PM_ID_NBR);//edit by titron
