...
static struct crtpLinkOperations nopLink = { .setEnable = nopFunc1, .sendPacket = nopFunc2, .receivePacket = nopFunc2, };
#endif
...
void crtpInit(void)
{
	...
	/* Start Rx/Tx tasks */
	xTaskCreate(crtpTxTask, (char const * const )"CRTP-Tx", configMINIMAL_STACK_SIZE, NULL, /*priority*/2, NULL);
	xTaskCreate(crtpRxTask, (char const * const )"CRTP-Rx", configMINIMAL_STACK_SIZE, NULL, /*priority*/2, NULL);
