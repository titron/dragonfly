...
typedef enum
{
	infoCopterNr = 0x00, infoBatteryNr = 0x01, infoWarningNr = 0x03
} InfoNbr;

typedef enum
{
	infoName = 0x00, infoVersion = 0x01, infoCpuId = 0x02
} infoId;

typedef enum
{
	batteryVoltage = 0x00, batteryMin = 0x01, batteryMax = 0x02
} batteryId;
...
void infoInit()
{
	xTaskCreate(infoTask, (char const * const )"Info", configMINIMAL_STACK_SIZE, NULL, /*priority*/2, NULL);
